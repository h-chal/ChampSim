...
class FileWriter:
    ...
    def write_files(self, parsed_config, bindir_name=None, srcdir_names=None, objdir_name=None):
        ...
        bsv_predictor = ""
        if 'bsv_predictor' in elements['cores'][0]:
            bsv_predictor = elements['cores'][0]['bsv_predictor']
        ...
        self.fileparts.append((makefile_file_name, makefile.get_makefile_lines(local_objdir_name, build_id, os.path.normpath(os.path.join(local_bindir_name, executable)), local_srcdir_names, joined_module_info, env, bsv_predictor_testing=bsv_predictor)))
